...
Once assigned a Capacity Partition, the miner packs it using [Irys’ 2D Packing](./packing). This process fully encodes the miner’s fingerprint into the partition.
