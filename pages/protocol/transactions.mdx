---
description: Irys supports value transfers, data transactions, and execution transactions. They enable efficient token transfers, data storage, and smart contract execution.
---
