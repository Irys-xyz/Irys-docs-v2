...
2. Staking and Slashing: Miners must stake `$IRYS` tokens when bringing a partition online. Irys incentivizes good behavior and penalizes malicious actions, enhancing network security and reliability of data replication.
