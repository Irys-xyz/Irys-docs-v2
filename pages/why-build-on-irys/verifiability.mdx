...
<div className="flex flex-col md:flex-row w-full flex justify-start items-start mt-5">
	<div className="w-full md:w-1/2">
		<div className="">
			In the world of blockchain and decentralization, verifiability is essential, ensuring data correctness
			and trustworthiness. For Irys, this principle is a core feature, making data verification fast,
...
- **Optimized Data Preparation**:<br/>
  Irys uses a method called [2D Packing](/mining-on-irys/2d-packing), which prepares storage efficiently and allows the protocol to avoid expensive sealing processes. Miners who (provably) provide storage resources properly benefit from greater rewards, while those who don’t face penalties.
  <br />
