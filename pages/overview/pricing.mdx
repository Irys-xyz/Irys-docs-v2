	...
	<div class="overflow-x-auto">
		<div class="w-5/6 ">
			<div class="border border-gray-400 text-xs">
				<div class="grid grid-cols-10 gap-2 border-gray-400 bg-slate-800">
					<div class="col-span-1 border-r px-1">Operation</div>
					<div class="col-span-1 border-r px-1">Operation Power Consumption</div>
					<div class="col-span-1 border-r px-1">Power Efficiency</div>
					<div class="col-span-1 border-r px-1">Transfer Rate (Reads)</div>
					<div class="col-span-1 border-r px-1">AC Power Consumption</div>
					<div class="col-span-1 border-r px-1">Operation Annual Share</div>
					<div class="col-span-1 border-r px-1">Hours in a Year</div>
					<div class="col-span-1 border-r px-1">Hours of Operation per year</div>
					<div class="col-span-1 border-r px-1">Hours Per Day</div>
					<div class="col-span-1 border-r px-1">Annual HDD AC Power consumption</div>
				</div>
				<div class="grid grid-cols-10 gap-2 border border-gray-400">
					<div class="col-span-1 border-r ml-2">R/W</div>
					<div class="col-span-1 border-r">6.50W</div>
					<div class="col-span-1 border-r">0.7</div>
					<div class="col-span-1 border-r">269MB/s</div>
					<div class="col-span-1 border-r">9.29W</div>
					<div class="col-span-1 border-r">80%</div>
					<div class="col-span-1 border-r">8760</div>
					<div class="col-span-1 border-r">7008</div>
					<div class="col-span-1 border-r">19.20 hours</div>
					<div class="col-span-1 border-r">65.07kWh</div>
				</div>
				<div class="grid grid-cols-10 gap-2 border-b border-gray-400">
					<div class="col-span-1 border-r ml-2">Idle</div>
					<div class="col-span-1 border-r">5.60W</div>
					<div class="col-span-1 border-r">0.7</div>
					<div class="col-span-1 border-r">-</div>
					<div class="col-span-1 border-r">8.00W</div>
					<div class="col-span-1 border-r">20%</div>
					<div class="col-span-1 border-r">8760</div>
					<div class="col-span-1 border-r">1752</div>
					<div class="col-span-1 border-r">4.80 hours</div>
					<div class="col-span-1 border-r">14.02kWh</div>
				</div>
				<div class="grid grid-cols-10 gap-2 border-b border-gray-400">
					<div class="col-span-7"></div>
					<div class="col-span-2 border-r text-right pr-2">Total Annual AC Consumption</div>
					<div class="col-span-1 border-r">79.09kWh</div>
				</div>
				<div class="grid grid-cols-10 gap-2 border-b border-gray-400">
					<div class="col-span-7"></div>
					<div class="col-span-2 border-r text-right pr-2">Total Annual Data Transferred</div>
					<div class="col-span-1 border-r">6,472TiB</div>
				</div>
				<div class="grid grid-cols-10 gap-2 border-gray-400 bg-slate-800">
					<div class="col-span-1 border-r px-1"></div>
					<div class="col-span-1 border-r px-1">Annualized Failure Rate</div>
					<div class="col-span-1 border-r px-1">Drive Price</div>
					<div class="col-span-1 border-r px-1">Drives In Datacenter</div>
					<div class="col-span-1 border-r px-1">Drives Replaced</div>
					<div class="col-span-1 border-r px-1">Replacement Costs</div>
					<div class="col-span-1 border-r px-1">Annual kWh Consumed</div>
					<div class="col-span-1 border-r px-1">Annual Energy Cost</div>
					<div class="col-span-1 border-r px-1">Annual Operation Expenses</div>
					<div class="col-span-1 border-r px-1">Annual Cost Per Drive</div>
				</div>
				<div class="grid grid-cols-10 gap-2 border-b border-t border-gray-400">
					<div class="col-span-1 border-r ml-2 break-words">Annualized cost</div>
					<div class="col-span-1 border-r">1.40%</div>
					<div class="col-span-1 border-r">$169.99</div>
					<div class="col-span-1 border-r">100</div>
					<div class="col-span-1 border-r">1.4</div>
					<div class="col-span-1 border-r">$237.99</div>
					<div class="col-span-1 border-r">7,909kWh</div>
					<div class="col-span-1 border-r">$1,001</div>
					<div class="col-span-1 border-r">$18,238</div>
					<div class="col-span-1 border-r">$182</div>
				</div>
				<div class="grid grid-cols-10 gap-2 border-gray-400">
						<div class="col-span-8"></div>
						<div class="col-span-1 border-r text-right pr-2">Cost of Power</div>
    				<div class="col-span-1">12.66 ¢/kWh</div>
    			</div>
    		</div>
    	</div>
    </div>
...
The **decay rate** represents the annual decrease in storage costs due to technological advancements. Historically, storage density improvements have followed an exponential trend, as described by Kryder's Law, which outpaced Moore's Law in the early 2000s. Although the rate of improvement has slowed in recent years, it still remains significant at around 28% annually.
...
<div className="mt-5">
	<div className="grid grid-cols-[1fr_6fr_6fr] gap-2 border border-gray-400 p-4 w-5/6">
...
<div className="mt-5 ">
  <div className="grid grid-cols-[1fr_6fr_6fr] gap-2 border border-gray-400 p-4 w-5/6">
    <div className="col-span-3  px-4 py-2 bg-slate-800 rounded-xl text-white">
      <Latex>{`$$\\text{Total cost} = \\text{Initial annual cost} \\times \\left( \\frac{1 - (1 - r)^n}{r} \\right)$$`}</Latex>
    </div>
    <div className="col-span-3 px-4 py-2 text-white ">
      <div className="mt-2">r = 0.01 - decay rate of 1%</div>
      <div>n = 200 - years to pay for storage</div>
    </div>

    <div className="flex items-center justify-center bg-[#FF8451] rounded-full text-xl m-2 text-white w-10 h-10">1</div>
    <div className="flex items-center">
      Calculate (1 - r)<sup>n</sup>
    </div>
    <div className="flex items-center">
      <Formula latexString={`$$(1 - 0.01)^{200} \\approx 0.1353$$`} />
    </div>

    <div className="flex items-center justify-center bg-[#FF8451] rounded-full text-xl m-2 text-white w-10 h-10">2</div>
    <div className="flex items-center">Subtract the result from 1</div>
    <div className="flex items-center">
      <Formula latexString={`$$1 - 0.1353 = 0.8647$$`} />
    </div>

    <div className="flex items-center justify-center bg-[#FF8451] rounded-full text-xl  m-2 text-white w-10 h-10">3</div>
    <div className="flex items-center">Divide the result by r</div>
    <div className="flex items-center">
      <Formula latexString={`$$\\frac{0.8647}{0.01} = 86.47$$`} />
    </div>

    <div className="flex items-center justify-center bg-[#FF8451] rounded-full text-xl m-2 text-white w-10 h-10">4</div>
    <div className="flex items-center">Multiply by the initial annual cost</div>
    <div className="flex items-center">
      <Formula latexString={`$$\\$0.01 \\times 86.47 = \\$0.8647$$`} />
    </div>
...
To determine the cost the protocol will charge, multiply the 1 GB cost by the number of replicas:

<div className="flex justify-start">
	<Latex>{`$$\\$0.8647 \\times 10 \\approx \\$8.65$$`}</Latex>
</div>

This results in a storage cost of **$8.65** per GB of permanent data.
...
<div className="mt-5">
  <div className="grid grid-cols-[1fr_6fr_6fr] gap-2 border border-gray-400 p-4 w-5/6">
    <div className="col-span-3 flex justify-center px-4 py-2 bg-slate-800 rounded-xl text-white">
      <table className="table-auto w-5/6 border border-gray-400">
        <thead>
