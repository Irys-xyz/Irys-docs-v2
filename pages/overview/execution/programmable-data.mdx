...
This enables use cases previously imposible on a single blockchain, like decentralized social media platforms with onchain posts, and interactions that reward users with tokens based on their activity.
