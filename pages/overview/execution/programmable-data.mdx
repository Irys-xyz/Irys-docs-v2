---
description: Programmable Data in Irys enables smart contracts to access all onchain data, reducing state storage costs and allowing innovative, fully onchain applications with flexible execution models.
---
...
This enables use cases previously impossible on a single blockchain, like decentralized social media platforms with onchain posts that reward users with tokens based on their activity.
