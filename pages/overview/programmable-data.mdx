import ProgrammableDataAnimation from "@/components/ProgrammableDataAnimation";

# Programmable data

<ProgrammableDataAnimation />

Programmable Data is a simple yet powerful concept: the ability for smart contracts to access any data provably stored
on the network. Irys’s advancements give smart contracts access to the entirety of onchain data during execution. With
Programmable Data, decentralized applications are free to explore a new frontier, fueled by computation meeting data at
scale.
