...
- **Optimized Data Preparation**:<br/>
  Irys uses a method called [Matrix Packing](/mining-on-irys/matrix-packing), which prepares storage efficiently and allows the protocol to avoid expensive sealing processes. Miners who (provably) provide storage resources properly benefit from greater rewards, while those who don’t face penalties.
  <br />
