...
Efficient Sampling is Irys's method for reading data from packed partitions and generating proofs. It complements the [2D Packing](/architecture/2d-packing) used to prepare storage partitions.
