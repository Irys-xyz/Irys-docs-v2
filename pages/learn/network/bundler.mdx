---
description: Bundlers enable any number of data transactions to be uploaded at once. 
---

# Bundlers

Bundlers enable any number of data transactions to be uploaded at once. 

## Bundles

The most common way to upload data to Irys is to first connect to a bundler and then call one of its upload functions. 
