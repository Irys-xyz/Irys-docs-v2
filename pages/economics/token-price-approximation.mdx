...
<div className="overflow-x-auto mx-1 rounded-2xl border border-gray-200 mt-5">
	<table className="min-w-full divide-y divide-gray-200 rounded-2xl">
		...
		<tbody className="divide-y divide-gray-200">
			<tr>
				<td className="px-4 py-2 whitespace-nowrap border border-gray-200">Block time</td>
				<td className="px-4 py-2 whitespace-nowrap border border-gray-200">~2min</td>
			</tr>
			<tr>
				<td className="px-4 py-2 whitespace-nowrap border border-gray-200">Adjustment Interval</td>
				<td className="px-4 py-2 whitespace-nowrap border border-gray-200">10 blocks (~20 min)</td>
			</tr>
			<tr>
				<td className="px-4 py-2 whitespace-nowrap border border-gray-200">Genesis Token Price</td>
				<td className="px-4 py-2 whitespace-nowrap border border-gray-200">$1.00 (for example)</td>
			</tr>
		</tbody>
	</table>
</div>
...
<div className="overflow-x-auto mx-1 rounded-2xl mt-5">
	<div className="grid grid-cols-1 md:grid-cols-[1fr_6fr_6fr] gap-2">
		<div className="col-span-1 md:col-span-3 px-4 py-2 border border-gray-200 rounded-2xl bg-slate-800 text-white">
			<Latex>{`$$EMA_b = \\alpha \\cdot P_b + (1 - \\alpha) \\cdot EMA_{b-1}$$`}</Latex>
		</div>
		<div className="col-span-1 md:col-span-3 px-4 py-2 border border-gray-200 rounded-2xl flex flex-col items-start">
