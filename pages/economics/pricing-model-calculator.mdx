...
<div className="overflow-x-auto mx-1 rounded-2xl border border-gray-200 mt-5">
	<table className="min-w-full divide-y divide-gray-200 rounded-2xl">
		...
		<tbody className="divide-y divide-gray-200">
			<tr>
				<td className="px-4 py-2 border border-gray-200">Annualized Storage Cost (per GB)</td>
				<td className="px-4 py-2 border border-gray-200">$0.01</td>
			</tr>
			<tr>
				<td className="px-4 py-2 border border-gray-200">Number of Replicas</td>
				<td className="px-4 py-2 border border-gray-200">10</td>
			</tr>
			<tr>
				<td className="px-4 py-2 border border-gray-200">Safe Minimum Time</td>
				<td className="px-4 py-2 border border-gray-200">200 years</td>
			</tr>
			<tr>
				<td className="px-4 py-2 border border-gray-200">Decay Rate</td>
