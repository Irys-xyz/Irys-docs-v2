...
export default function Home() {
  ...
  return (
    <div
      className={`text-white flex relative overflow-hidden ${satoshi.className}`}
    >
      <AnimatePresence>
        {buttonHovered && (
          <motion.img
          ...
          <div className="relative col-span-12 justify-between items-center grid grid-cols-12 w-full">
            ...
            <div className="col-span-12 md:col-span-6 flex flex-col gap-10 items-start justify-center  p-7 md:p-12 ">
              ...
              <p className="text-[#959595] leading-loose">
                Easily interact with and perform computations on user data
                within a virtual machine (VM). Traditionally, smart contracts
                had limited access to user data due to high storage costs on
                computation-optimized protocols. Irys optimizes for both,
                allowing smart contracts to easily retrieve onchain data.
                <br />
                <br />
                With programmable data, anyone can build large-scale apps and
                services on a single decentralized protocol, including AI
                agents, DePIN networks, and other Web3 insfrastructure.
              </p>
            </div>
          ...
          <div className="grid grid-cols-12 col-span-12 px-7 md:px-12">
            <div className="col-span-12 md:col-span-4 pt-12 pr-8">
              ...
              <p className="text-[#959595] pt-7 leading-loose">
                ...
                have the freedom to build fully onchain applications.
                <br />
                <br />
                The Irys L1 blockchain uniquely integrates verifiable compute
                and verifiable data, empowering developers to unleash their
            ...
            <div className="col-span-12 md:col-span-4 px-0 md:px-8 md:border-x pt-12 border-[#222222] border-x-0 border-y md:border-y-0 mt-10 pb-10 md:mt-0 md:pb-0">
              ...
              <p className="text-[#959595] pt-7 leading-loose">
                ...
                <br />
                <br />
                With programmable data, you can: - Access uploaded transaction
                data within the MV. - Prove and verify computations done
                onchain.
              </p>
            </div>
            <div className="col-span-12 md:col-span-4 pt-12 pl-0 md:pl-8">
              ...
              <p className="text-[#959595] pt-7 leading-loose">
                ...
                forever. <br />- <b>Term Data:</b> You control how long it’s
                retrievable for
              </p>
            </div>
          </div>
