...
[Ethers v5](#ethers-v5) |  [Ethers v6](#ethers-v6) | [Viem v2](#viem-v2) | [Privy](#privy) | [Solana](#solana) | [Aptos](#aptos) | 
</div>
...
npm install \
    @irys-network/web-bundler-ethereum \
    @irys-network/web-bundler-ethereum-privy \
...
Finally create a component called `ConnectWebIrys.tsx` that connects to an Irys Bundler. 
