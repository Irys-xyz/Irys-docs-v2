...
<Callout type="info" emoji="ℹ️">
	The following `getIrys()` function is for using the Ethereum token only, we [also have examples covering all of the tokens we support for payment](/build/d/sdk/import-configure). 
</Callout>
