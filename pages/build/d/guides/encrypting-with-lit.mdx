...
<img className="rounded-xl mt-5" src="/build/guides/lit-protocol/encrypting-onchain-data.jpg" />
...
<img className="rounded-xl mt-5" src="/build/guides/lit-protocol/decrypting-onchain-data.jpg" />
