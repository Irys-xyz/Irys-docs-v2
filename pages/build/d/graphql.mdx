...
Clicking on the [endpoint URL](https://uploader.irys.xyz/graphql) above will take you to the GraphQL Sandbox used for building and testing queries. Press Control+Space at any time to see an interactive popup window of either query arguments or results fields.
