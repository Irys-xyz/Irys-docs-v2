---
description: Search Irys transaction metadata using GraphQL.
---
...
<img className="border border-[#FEF4EE] rounded mt-5 w-5/6" src="/build/img/GQL-Anatomy.png" />
...
| `owner` | The address used when posting the transaction. Can be a native address from [any of the chains supported by Irys](/build/onchain-data/features/supported-tokens). Note in results fields, this is referred to as `address`. |
| `token` | The [token](/build/onchain-data/features/supported-tokens) used to pay for the transaction.                                                                                                                                 |
...
Clicking on the [endpoint URL](https://testnet-upload.irys.xyz/graphql) above will take you to the GraphQL Sandbox used for building and testing queries. Press Control+Space at any time to see an interactive popup window of either query arguments or results fields.

<img className="border border-[#FEF4EE] rounded mt-5 w-5/6" src="/build/img/GQL-Sandbox.png" />
...
Search for transactions matching [tag](/build/onchain-data/features/tags) name / value pairs:
