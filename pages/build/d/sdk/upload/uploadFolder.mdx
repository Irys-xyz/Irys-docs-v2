...
See:
- [`Irys`](#irysuploadfolderfoldertoupload-tags): For uploading a folder on the server.
- [`WebIrys`](#webirysuploadfoldertaggedfile): For uploading a folder from the browser. 
