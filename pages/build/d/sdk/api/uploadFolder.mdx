...
<ApiTable columns={[
	...
	{ header: "Description", key: "description", span: 8 },
	  ...
	  { name: "folderToUpload", type: "string", description: "Path to the folder being uploaded." },
		{ name: "indexFile", type: "string", description: "(optional) The name of an index file also included in the folder you upload. If provided, this index file will load when a user requests `https://gateway.irys.xyz/[manifest_id]`." },
