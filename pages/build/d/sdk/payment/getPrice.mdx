...
<ApiTable columns={[
  ...
  { header: "Description", key: "description", span: 10 },
    ...
    { type: "BigNumber", description: "Cost to upload `numBytes`, unit is the token specified when instantiating the `Irys` object. Return value is in atomic units, to convert to standard units use [`irys.utils.fromAtomic()`](./utils-fromAtomic)." },
]}/>
