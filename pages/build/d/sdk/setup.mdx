...
The following code examples connect to our private testnet. To switch to our devnet, append the functions `withRpc()` and `devnet()` as [outlined here](/build/d/networks#connecting-to-devnet). 
</Callout>
