...
- [Error: Using Irys testnet requires a dev/testnet RPC to be configured](/irys-sdk/troubleshooting#testnet-rpc)
...
When using our testnet, you must provide the URL to a Denvet RPC for the chain you're using.
