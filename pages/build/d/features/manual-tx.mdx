...
In addition to uploading using the SDK functions [`irys.upload()`](/build/onchain-data/sdk/api/upload),[`irys.uploadFile()`](/build/onchain-data/sdk/api/uploadFile),
and [`irys.uploadFolder()`](/build/onchain-data/sdk/api/uploadFolder), you can also manually create, sign, and upload a transaction in separate steps.
