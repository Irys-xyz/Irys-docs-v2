...
In addition to uploading using the SDK functions [`irys.upload()`](/build/d/sdk/upload/upload),[`irys.uploadFile()`](/build/d/sdk/upload/uploadFile),
and [`irys.uploadFolder()`](/build/d/sdk/upload/uploadFolder), you can also manually create, sign, and upload a transaction in separate steps.
