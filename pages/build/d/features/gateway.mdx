...
Transaction metadata is queryable via [GraphQL](/build/d/graphql) or [REST APIs](/build/d/rest-api), enabling users to create custom queries, such as searching for specific tags or addresses.
