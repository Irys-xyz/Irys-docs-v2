...
Queries return transaction metadata. To then retrieve data, use the returned transaction ID and download the data from the Irys gateway using a URL formed as follows `https://gateway.irys.xyz/[transaction-id]`.
