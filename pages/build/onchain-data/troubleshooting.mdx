...
- [Error: Using Irys devnet requires a dev/testnet RPC to be configured](/irys-sdk/troubleshooting#devnet-rpc)
...
When using our [devnet](./using-devnet), you must provide the URL to a Denvet RPC for the chain you're using.
