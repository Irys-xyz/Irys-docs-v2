...
- Categorize transactions, making it easier to [search for and retrieve relevant information](/build/onchain-data/graphql)
- Build [mutable references](/build/onchain-data/features/mutable-references)
- Inform web browsers how to render files

## Querying

Tags are indexed by gateways and are queryable using [GraphQL](/build/onchain-data/graphql).
...
You can also add tags via the [CLI's](/build/onchain-data/storage-cli/installation) `-t` option, followed by a series of name / value pairs
