...
The chunked uploader has two modes of operation, data mode and [transaction mode](/irys-sdk/chunked-uploader/transaction-mode). When using data mode do not create a transaction, this will be done automatically for you.
