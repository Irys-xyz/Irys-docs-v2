...
- [`Irys`](./uploadFolder#irysuploadfolder): For uploading a folder on the server.
- [`WebIrys`](./uploadFolder#webirysuploadfolder): For uploading a folder from the browser. 
