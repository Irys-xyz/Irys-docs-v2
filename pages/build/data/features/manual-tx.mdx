...
In addition to uploading using the SDK functions [`irys.upload()`](/build/data/sdk/api/upload),[`irys.uploadFile()`](/build/data/sdk/api/uploadFile),
and [`irys.uploadFolder()`](/build/data/sdk/api/uploadFolder), you can also manually create, sign, and upload a transaction in separate steps.
