...
- Categorize transactions, making it easier to [search for and retrieve relevant information](/build/data/graphql)
- Build [mutable references](/build/data/features/mutable-references)
- Inform web browsers how to render files

## Querying

Tags are indexed by gateways and are queryable using [GraphQL](/build/data/graphql).
...
You can also add tags via the [CLI's](/build/data/storage-cli/installation) `-t` option, followed by a series of name / value pairs
