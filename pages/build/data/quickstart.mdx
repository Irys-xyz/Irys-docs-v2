...
<Callout type="info" emoji="ℹ️">
	...
	guide](/build/data/troubleshooting#bigint).
</Callout>
...
Fund your account on the Irys network using any of our [supported tokens](/build/data/features/supported-tokens):
...
<Callout type="info" emoji="ℹ️">
	When [uploading a folder](/build/data/sdk/api/uploadFolder), files can be accessed either directly at
