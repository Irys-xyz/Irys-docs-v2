...
<Callout emoji="🚀">
	...
	steps](/build/data/guides/irys-react).
</Callout>
...
```js
import { WebIrys } from "@irys-network/bundler-sdk";
```
...
- `network`: "testnet"
- `token`: Payment [token](/build/data/features/supported-tokens)
...
Fund a node using any of our [supported tokens](/build/data/features/supported-tokens):
...
Upon upload, a manifest is automatically created. Your files can be accessed `https://testnet-gateway.irys.xyz/[manifestId]/[file-name]`.
