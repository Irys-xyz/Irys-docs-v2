...
- `indexFile`: (optional) The name of an
  ...
  `https://testnet-gateway.irys.xyz/[manifest_id]`
...
A JSON object containing the following values. A receipt is also generated which can be retrieved using [`irys.utils.getReceipt(response.id)`](/build/data/sdk/api/utils-getReceipt)
