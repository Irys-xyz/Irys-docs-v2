...
```console
npm install @irys-network/bundler-sdk ethers@6
```

Change your `App.tsx` file as follows. This example uses ethers6, if you're using [a different provider](/build/data/irys-in-the-browser#supported-providers) make sure to specify it when creating the `wallet`.
