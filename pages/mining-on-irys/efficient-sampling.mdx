...
Efficient Sampling is Irys' method for reading data from packed partitions and generating proofs. It complements the [Matrix Packing](/architecture/matrix-packing) used to prepare storage partitions.
