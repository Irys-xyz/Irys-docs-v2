	...
	const devToolsForArweave: Section[] = [
		{
			...
			css: "row-span-6",
			items: [
				{ title: "Tools For Arweave", href: `${arweaveToolsBaseUrl}/overview/about` },
				{ title: "Networks", href: `${arweaveToolsBaseUrl}/overview/networks` },
				{ title: "Downloading Data", href: `${arweaveToolsBaseUrl}/overview/downloading` },
				{ title: "Cost To Upload", href: `${arweaveToolsBaseUrl}/overview/cost-to-upload` },
				{ title: "Supported Tokens", href: `${arweaveToolsBaseUrl}/overview/supported-tokens` },
			],
			subItems: [
				{ title: "Basics", href: `${arweaveToolsBaseUrl}/tutorials/basics/react` },
				{ title: "NFTs", href: `${arweaveToolsBaseUrl}/tutorials/nfts/dynamic-nft` },
				{
					title: "Encryption",
		...
		},
		{
			...
			css: "row-span-6",
			items: [
				{ title: "Installing the SDK", href: `${arweaveToolsBaseUrl}/irys-sdk/installing-the-sdk` },
				{ title: "Troubleshooting", href: `${arweaveToolsBaseUrl}/irys-sdk/troubleshooting` },
				{ title: "Community SDKs", href: `${arweaveToolsBaseUrl}/irys-sdk/community-sdk` },
				{ title: "Irys In The Browser", href: `${arweaveToolsBaseUrl}/irys-sdk/irys-in-the-browser` },
				{ title: "API Docs", href: `${arweaveToolsBaseUrl}/irys-sdk/irys-sdk/api/upload` },
				{ title: "Chunked Uploader", href: `${arweaveToolsBaseUrl}/irys-sdk/chunked-uploader` },
				{ title: "Using IPFS CIDs", href: `${arweaveToolsBaseUrl}/irys-sdk/ipfs-cid` },
				{ title: "Manually Creating A Tx", href: `${arweaveToolsBaseUrl}/irys-sdk/manual-transaction` },
				{ title: "Balance Approvals", href: `${arweaveToolsBaseUrl}/irys-sdk/balance-approvals` },
				{ title: "Mutable References", href: `${arweaveToolsBaseUrl}/irys-sdk/mutable-references` },
				{ title: "Path Manifests", href: `${arweaveToolsBaseUrl}/irys-sdk/path-manifests` },
				{ title: "Tags", href: `${arweaveToolsBaseUrl}/irys-sdk/path-manifests` },
				{ title: "Using Devnet", href: `${arweaveToolsBaseUrl}/irys-sdk/using-devnet` },
			],
		},
		{
			title: "CLI",
			css: "row-span-6",
			items: [
				{ title: "Installation", href: `${arweaveToolsBaseUrl}/cli/installation` },
		...
		},
		{
			...
			css: "row-span-6",
			items: [
				{ title: "Query Package", href: `${arweaveToolsBaseUrl}/cli/commands/fund` },
				{ title: "API Docs", href: `${arweaveToolsBaseUrl}/querying/api/token` },
