			...
			<div className="px-5 pb-5">
				<div className="flex flex-row mt-5">
					...
					<div className="flex flex-col items-start ml-5">
						...
						The foundational building block of storage on Irys is the 16TB partition. Irys partitions data logically
						into these partitions which can then be stored on individual 16TB HDDs. SSDs do not provide a mining
						advantage for reasons that will be discussed later.
					</div>
				</div>
				...
				<div className="flex flex-row mt-5">
					...
					<div className="flex flex-col items-start ml-5">
						...
						Each chunk is further divided into segments 32 bytes in size. These segments contain the packing entropy
						that is the result of a SHA-256 hash.
					</div>
				</div>
			</div>
		</div>
